...
(async () => {
  ...
  // 3. Liga a troca de timbre e espera ela ficar de pe de verdade. Carregar na
  //    GPU leva de 4s a 20s conforme a placa ja tenha sido escolhida ou nao --
  //    esperar um numero fixo aqui e o que fazia este teste falhar sozinho.
  ...
  console.log('  media (sem os 2 primeiros): ' + media + 'ms de 500ms  -> ' + (media/500).toFixed(2) + 'x');
